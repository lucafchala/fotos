  ...
  <main>
    ...
    <div class="key">
      ...
      <ul>
        ...
        <li><strong>Publicação editorial, jornalística, cultural e educacional</strong> — em jornais, revistas e publicações estudantis ou escolares (como o jornal do colégio), zines, catálogos, exposições, mostras e concursos de fotografia e em obras ou coletâneas coletivas, em meio impresso ou digital, sem caráter publicitário.</li>
      </ul>
      <p>A autorização é <strong>gratuita</strong>, por prazo indeterminado e válida para todo o território nacional, e abrange a reprodução, a exibição e a veiculação das imagens para as finalidades acima. As imagens <strong>não são vendidas a terceiros</strong>, não são licenciadas para uso comercial de terceiros e <strong>não são usadas em publicidade de produtos ou serviços de terceiros</strong>. Você pode revogar esta autorização e pedir a remoção das suas fotos a qualquer momento (veja o item 7).</p>
    </div>
